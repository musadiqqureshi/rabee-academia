...
export const courses: Course[] = [
  {
    ...
    description: "A free 2-week weekend bootcamp on practical AI — tools, prompt engineering and automation. Limited to 50 seats. Starts July 2026.",
