...
export interface Course {
  ...
  launchPrice?: number;   // discounted launch-offer price (overrides other discounts)
  icon: LucideIcon;
  gradient: string;
  features: string[];
  description: string;
...
export const courses: Course[] = [
  {
    slug: "ai-mastery",
    level: "Special",
    name: "Introductory AI Mastery Course",
    lessons: 24,
    regularPrice: 0,
    weekendPrice: 0,
    icon: Sparkles,
    gradient: "from-fuchsia-600 via-purple-600 to-indigo-600",
    description: "A free 2-week weekend bootcamp on practical AI — tools, prompt engineering and automation. Batch 1 is full — Batch 2 coming soon.",
    features: ["2-week intensive (weekends)", "Hands-on AI projects", "Prompt engineering", "Certificate of completion"],
    free: true,
    special: true,
    comingSoon: true,
    seatLimit: 50,
    duration: "2 weeks",
    schedule: "Weekends",
    badge: "Batch 1 Full · Batch 2 Soon",
  },
  // ---- Quran Learning (launch offer: PKR 11,000 → 5,000) ----
  {
    ...
    description: "Build a strong foundation for Quran reading from the very first letter, with correct makharij.",
    features: ["One-to-one live classes", "Certified teacher", "Weekly homework", "AI revision assistant"],
  },
  {
    slug: "quran-nazra",
    level: "Quran",
    ...
    description: "Learn fluent, confident Quran recitation with proper flow and rhythm.",
    features: ["One-to-one live classes", "Certified teacher", "Weekly homework", "AI revision assistant"],
  },
  {
    slug: "quran-tajweed",
    ...
    description: "Master correct pronunciation and the rules of articulation for beautiful recitation.",
    features: ["One-to-one live classes", "Certified teacher", "Tajweed correction", "AI revision assistant"],
  },
  {
    slug: "quran-hifz",
    level: "Quran",
    ...
    launchPrice: 5000,
    icon: BookOpen,
    gradient: "from-cyan-500 via-sky-400 to-blue-600",
    description: "Structured memorization with smart, spaced revision plans and consistent tracking.",
    features: ["One-to-one live classes", "Hafiz teacher", "Spaced revision plan", "AI revision assistant"],
  },
  {
    ...
    description: "Daily Duas, Salah, Islamic manners and basic Aqeedah — age-appropriate and practical.",
    features: ["One-to-one live classes", "Certified teacher", "Daily Duas & Salah", "Monthly assessment"],
  },
  {
    slug: "quran-translation",
    level: "Quran",
    name: "Quran Translation & Understanding",
    lessons: 30,
    regularPrice: 11000,
    weekendPrice: 11000,
    launchPrice: 5000,
    icon: BookOpen,
    gradient: "from-fuchsia-500 via-purple-400 to-purple-600",
    description: "Understand selected Surahs and their meanings through age-appropriate lessons.",
    features: ["One-to-one live classes", "Certified teacher", "Surah-by-Surah meaning", "AI revision assistant"],
  },
  {
    slug: "fsc-physics",
    level: "FSc Level",
