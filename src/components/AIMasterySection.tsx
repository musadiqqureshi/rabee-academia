import { Sparkles, Calendar, ArrowRight, CheckCircle2, Briefcase, Clock } from "lucide-react";
        ...
        <div className="glow-card relative max-w-4xl mx-auto rounded-3xl bg-gradient-to-br from-fuchsia-600 via-purple-600 to-indigo-600 p-[1.5px]">
          <div className="rounded-[calc(1.5rem-1.5px)] bg-card/95 backdrop-blur-sm p-8 md:p-10">
            <div className="flex flex-wrap items-center gap-3 mb-4">
              ...
              <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-rose-500/15 text-rose-600 text-xs font-bold ring-1 ring-rose-500/25">Batch 1 — Full</span>
            </div>
            ...
            <div className="grid md:grid-cols-[1fr_auto] gap-8 items-center">
              <div>
                ...
                <div className="flex flex-wrap gap-x-4 gap-y-2 text-sm">
                  ...
                  <span className="inline-flex items-center gap-1.5 font-semibold text-rose-600"><CheckCircle2 className="w-4 h-4" /> Batch 1: Full</span>
                  <span className="inline-flex items-center gap-1.5 font-semibold text-amber-600"><Clock className="w-4 h-4" /> Batch 2: Coming soon</span>
                </div>
              ...
              <div className="text-center shrink-0">
                ...
                <p className="text-xs text-muted-foreground mb-4">Batch 2 · seats open soon</p>
                <span className="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-xl bg-muted text-muted-foreground text-sm font-bold cursor-default">
                  <Clock className="w-4 h-4" /> Batch 2 — Coming Soon
                </span>
              </div>
            </div>
