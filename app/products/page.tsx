...
import { FileText, Sparkles, ArrowRight, ClipboardCheck, BookOpen, StickyNote, CalendarDays, ListChecks, Wand2, GraduationCap, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="min-h-screen text-foreground relative">
      ...
      <div className="pt-28 pb-20 container mx-auto px-4 md:px-6">
        ...
        {/* Featured: AI Humanizer */}
        <div className="relative max-w-2xl mx-auto mb-12">
          <div className="absolute -inset-1 rounded-[1.75rem] bg-gradient-to-r from-violet-600 via-fuchsia-500 to-violet-600 blur-xl opacity-70 animate-pulse" />
          <Link href="/products/humanizer" className="group relative block rounded-3xl border-2 border-fuchsia-400/50 bg-card overflow-hidden shadow-[0_0_45px_rgba(217,70,239,0.45)]">
            ...
            <div className="relative p-7 flex flex-col items-center text-center">
              ...
              <h2 className="text-2xl font-extrabold mb-1">Rabee&apos;s AI Humanizer</h2>
              <p className="text-sm text-muted-foreground max-w-md mb-5">Rewrite AI-generated text so it reads 100% human — bypass AI detectors while keeping your length, tone and meaning. Free up to 2,000 words/day.</p>
              <span className="inline-flex items-center gap-2 px-6 py-2.5 rounded-xl bg-gradient-to-r from-primary to-accent text-white text-sm font-bold group-hover:gap-3 transition-all shadow-[0_0_20px_rgba(99,102,241,0.4)]">
