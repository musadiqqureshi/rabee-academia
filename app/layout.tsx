  ...
  "@graph": [
    {
      ...
      telephone: "+92 308 6994758",
      areaServed: ["Pakistan", "Saudi Arabia", "UAE", "Qatar", "United Kingdom"],
      address: { "@type": "PostalAddress", addressCountry: "PK" },
      sameAs: [
        "https://www.facebook.com/share/1EazecLuwr/?mibextid=wwXIfr",
        "https://www.instagram.com/rabeeacademia",
      ],
    },
    {
      "@type": "WebSite",
    ...
    // Helps Google surface sitelinks (sub-pages under the main result).
    {
      ...
      name: "Rabee Academia",
      itemListElement: [
        { "@type": "SiteNavigationElement", position: 1, name: "Quran Learning", url: `${SITE_URL}/quran-learning` },
        { "@type": "SiteNavigationElement", position: 2, name: "Pricing & Courses", url: `${SITE_URL}/pricing` },
        { "@type": "SiteNavigationElement", position: 3, name: "AI Tools", url: `${SITE_URL}/products` },
        { "@type": "SiteNavigationElement", position: 4, name: "AI Career Stack", url: `${SITE_URL}/ai-career-stack` },
        { "@type": "SiteNavigationElement", position: 5, name: "Book a Free Demo", url: `${SITE_URL}/demo` },
        { "@type": "SiteNavigationElement", position: 6, name: "Become an Instructor", url: `${SITE_URL}/instructor` },
        { "@type": "SiteNavigationElement", position: 7, name: "FAQ", url: `${SITE_URL}/faq` },
      ],
    },
